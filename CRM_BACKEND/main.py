...
# Initialize Firebase Admin SDK if credential file is present
...
try:
    if os.path.exists("firebase-service-account.json"):
        ...
        print("Firebase credential file (firebase-service-account.json) not found. Push notifications will be database-only.")
except Exception as e:
